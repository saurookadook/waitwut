...
function VueJSWordmarkIconEl(
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props} ref={ref}>
            ...
            <path
                fill="#35495e"
                d="M31.404.394L51.133.4l12.896 21.407L76.88.403 96.592.398 64.128 56.71z"
            />
            <path
                fill="#41b883"
                d="M9.887.544l21.5-.146 32.722 56.315L96.575.401l21.537.023-54.007 92.684z"
            />
        </svg>
    );
}

export const VueJSWordmarkIcon = React.forwardRef(VueJSWordmarkIconEl);
