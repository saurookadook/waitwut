    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props} ref={ref}>
            ...
            <path
                ...
                d="M38.906 87.709l9.879-32.724 32.811 10.541c-11.864 11.125-25.058 20.528-42.69 22.183z"
            />
            <linearGradient
                id="ruby-original-wordmark-k"
                gradientUnits="userSpaceOnUse"
                x1="145.839"
                y1="2168.67"
                x2="128.08"
...
export const RubyWordmarkIcon = React.forwardRef(RubyWordmarkIconEl);
