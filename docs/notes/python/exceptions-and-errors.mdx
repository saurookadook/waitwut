...
title: "Collections"
date: "2024-02-28"
fullPath: "/notes/python/exceptions-and-errors"
...
- Full class hierarchy for built-in exceptions can be found in Python's docs: [Exception hierarchy](https://docs.python.org/3/library/exceptions.html#exception-hierarchy)
...
- two main use cases
    ...
    - 2. **explicit chaining**: when we wish to deliberately handle exception by translating it into different exception type
